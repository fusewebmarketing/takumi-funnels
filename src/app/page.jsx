      ...
      <nav className="border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-white">Takumi Digital</span>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-400 max-w-xl mx-auto mb-12">
            Get your <strong className="text-white">free AEO Audit</strong> and discover exactly where you stand — 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#111111] border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-white">AI Visibility Score</h3>
            ...
            <div className="bg-[#111111] border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-white">Competitor Analysis</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="bg-[#111111] border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-white">3 Quick Wins</h3>
              <p className="text-gray-400 text-sm">
      ...
      <footer className="py-8 px-4 border-t border-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white">Takumi Digital</span>
          </div>
